...
const transactions = [
  { id: 1, date: "1/05/2025", tag: "Dining Out", name: "Starbucks", amount: -13.50 },
  { id: 2, date: "1/06/2025", tag: "Transportation", name: "Uber", amount: -22.00 },
  { id: 3, date: "1/08/2025", tag: "Entertainment", name: "Netflix Subscription", amount: -15.99 },
  { id: 4, date: "1/10/2025", tag: "Income", name: "Paycheck", amount: 2500.00 },
  { id: 5, date: "1/12/2025", tag: "Dining Out", name: "Panda Express", amount: -27.00 },
  { id: 6, date: "1/14/2025", tag: "Subscription", name: "Disney+ Subscription", amount: -8.99 },
  { id: 7, date: "1/16/2025", tag: "Utilities", name: "Electric Bill - PG&E", amount: -120.00 },
  ...
  { id: 10, date: "1/22/2025", tag: "Entertainment", name: "Spotify Subscription", amount: -11.99 },
  { id: 11, date: "1/24/2025", tag: "Dining Out", name: "Chipotle", amount: -30.00 },
  { id: 12, date: "1/25/2025", tag: "Transportation", name: "Monthly Metro Pass", amount: -70.00 },
  { id: 13, date: "1/27/2025", tag: "Housing", name: "Rent - Apartment Complex", amount: -1450.00 },
  { id: 14, date: "1/28/2025", tag: "Dining Out", name: "McDonald's", amount: -15.00 },
  { id: 15, date: "1/30/2025", tag: "Subscription", name: "Amazon Prime Subscription", amount: -12.99 },

  { id: 1, date: "2/01/2025", tag: "Dining Out", name: "Chipotle", amount: -28.50 },
  { id: 2, date: "2/03/2025", tag: "Utilities", name: "Electric Bill - PG&E", amount: -120.00 },
  { id: 3, date: "2/05/2025", tag: "Entertainment", name: "Netflix Subscription", amount: -15.99 },
  { id: 4, date: "2/07/2025", tag: "Income", name: "Paycheck", amount: 2500.00 },
  { id: 5, date: "2/09/2025", tag: "Dining Out", name: "Starbucks", amount: -13.00 },
  ...
  { id: 8, date: "2/14/2025", tag: "Entertainment", name: "Spotify Subscription", amount: -11.99 },
  { id: 9, date: "2/15/2025", tag: "Income", name: "Freelance Project", amount: 1800.00 },
  { id: 10, date: "2/17/2025", tag: "Entertainment", name: "HBO Max Subscription", amount: -14.99 },
  { id: 11, date: "2/18/2025", tag: "Debt Payment", name: "Student Loan - Nelnet", amount: -350.00 },
  { id: 12, date: "2/20/2025", tag: "Dining Out", name: "Panda Express", amount: -25.00 },
  { id: 13, date: "2/22/2025", tag: "Transportation", name: "Lyft", amount: -18.00 },
  { id: 14, date: "2/25/2025", tag: "Housing", name: "Rent - Apartment Complex", amount: -1450.00 },
  { id: 15, date: "2/28/2025", tag: "Dining Out", name: "Chipotle", amount: -32.00 },

  { id: 1, date: "3/01/2025", tag: "Dining Out", name: "Starbucks", amount: -12.50 },
  { id: 2, date: "3/03/2025", tag: "Utilities", name: "Electric Bill - PG&E", amount: -125.00 },
  { id: 3, date: "3/05/2025", tag: "Entertainment", name: "Netflix Subscription", amount: -15.99 },
  { id: 4, date: "3/07/2025", tag: "Income", name: "Paycheck", amount: 2500.00 },
  { id: 5, date: "3/09/2025", tag: "Dining Out", name: "Chipotle", amount: -29.00 },
  ...
  { id: 10, date: "3/20/2025", tag: "Entertainment", name: "Spotify Subscription", amount: -11.99 },
  { id: 11, date: "3/22/2025", tag: "Dining Out", name: "Panda Express", amount: -26.00 },
  { id: 12, date: "3/24/2025", tag: "Transportation", name: "Lyft", amount: -18.00 },
  { id: 13, date: "3/26/2025", tag: "Housing", name: "Rent - Apartment Complex", amount: -1450.00 },
  { id: 14, date: "3/28/2025", tag: "Dining Out", name: "McDonald's", amount: -15.00 },
  { id: 15, date: "3/30/2025", tag: "Subscription", name: "Amazon Prime Subscription", amount: -12.99 },

  { id: 1, date: "4/01/2025", tag: "Dining Out", name: "Panda Express", amount: -27.50 },
  { id: 2, date: "4/03/2025", tag: "Utilities", name: "Electric Bill - PG&E", amount: -130.00 },
  { id: 3, date: "4/05/2025", tag: "Entertainment", name: "Netflix Subscription", amount: -15.99 },
  { id: 4, date: "4/07/2025", tag: "Income", name: "Paycheck", amount: 2500.00 },
  { id: 5, date: "4/09/2025", tag: "Dining Out", name: "Starbucks", amount: -14.00 },
  ...
  { id: 10, date: "4/20/2025", tag: "Entertainment", name: "Spotify Subscription", amount: -11.99 },
  { id: 11, date: "4/22/2025", tag: "Dining Out", name: "Chipotle", amount: -29.00 },
  { id: 12, date: "4/24/2025", tag: "Transportation", name: "Lyft", amount: -18.00 },
  { id: 13, date: "4/26/2025", tag: "Housing", name: "Rent - Apartment Complex", amount: -1450.00 },
  { id: 14, date: "4/28/2025", tag: "Dining Out", name: "McDonald's", amount: -16.00 },
